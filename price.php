...
if (isset($_POST['health_condition'])) {
    ...
    // SQL query to fetch the medicine name, retail price, and our price
    $select_sql = "SELECT medicine_name, retail_price, our_price FROM medicine WHERE health_condition = '$health_condition'";
